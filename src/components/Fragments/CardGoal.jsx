  ...
  const chartData = (
    <div className="p-2 ">
      ...
      <div className="flex justify-between ">
        <div>
          <div className="flex mt-3 mb-10 text-gray-01 dark:text-dark-desc">
            <Icon.Award />
            <div className="ms-2">
              <div>Target Achieved</div>
              <div className="font-bold text-xl text-black dark:text-dark-title">
                ${data.present_amount}
              </div>
            </div>
          </div>
          <div className="flex text-gray-01 dark:text-dark-desc">
            <Icon.Target />
            <div className="ms-2">
